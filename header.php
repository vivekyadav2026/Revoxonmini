...
<body>
    ...
    <!-- Topbar -->
    <div class="topbar-utility d-none d-lg-block py-1">
        <div class="container-fluid px-xl-5 px-3">
            <div class="row align-items-center">
                <div class="col-md-6 text-start">
                    <span class="me-4"><i class="fas fa-envelope text-orange-accent me-2"></i><a href="mailto:info@revoxon.com" class="text-decoration-none">info@revoxon.com</a></span>
                    <span><i class="fas fa-phone-alt text-orange-accent me-2"></i><a href="tel:+919825706253" class="text-decoration-none">+91 98257 06253 / +91 94608 61021 / +91 82009 45366</a></span>
                </div>
